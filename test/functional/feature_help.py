...
"""Verify that starting ecurrency with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ecurrency with -h for help text")
        ...
        self.log.info("Start ecurrency with -version for version information")
        ...
        self.log.info("Start ecurrencyd with -fakearg to make sure it does not start")
