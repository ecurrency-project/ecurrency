...
The following applies to code changes to the ECurrency Core project, and is not to be confused with overall ECurrency
...
Copyright
---------
Copyright 2017 The ECurrency Core Developers

- litecoin: Copyright (c) 2017 The Litecoin Core Developers
