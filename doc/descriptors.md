# Support for Output Descriptors in eCurrency Core

Since eCurrency Core v0.17, there is support for Output Descriptors in the
...
on eCurrency's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing eCurrency Core wallets, a convenience function `combo` is
