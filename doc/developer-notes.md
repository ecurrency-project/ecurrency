...
Run with the -testnet option to run with "play ecurrencys" on the test network, if you
...
ECurrency Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- BitcoinMiner : Generates ecurrencys (if wallet is enabled).
