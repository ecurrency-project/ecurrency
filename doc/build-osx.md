...
1. Clone the eCurrency Core source code:
    ```shell
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, eCurrency Core may be
...
```shell
mkdir -p "/Users/${USER}/Library/Application Support/eCurrency"

touch "/Users/${USER}/Library/Application Support/eCurrency/ecurrency.conf"

chmod 600 "/Users/${USER}/Library/Application Support/eCurrency/ecurrency.conf"
```

The first time you run ecurrencyd, it will start downloading the blockchain. This process could
