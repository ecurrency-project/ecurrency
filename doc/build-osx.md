...
1. Clone the ecurrency source code and cd into `ecurrency`
...
2.  Build ecurrency-core:
    ...
    Configure and build the headless ecurrency binaries as well as the GUI (if Qt is found).
...
------------------------
You can use Qt Creator as an IDE, for ecurrency development.
