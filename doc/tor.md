...
It is possible to run eCurrency Core as a Tor hidden service, and connect to such services.
...
for normal IPv4/IPv6 communication, use:
	...
	./ecurrencyd -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
...
- Do not add anything but eCurrency Core ports to the hidden service created in section 2.
