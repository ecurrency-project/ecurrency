...
In a typical situation, this suffices to run behind a Tor proxy:
	...
	./ecurrency -proxy=127.0.0.1:9050


2. Run a ecurrency hidden server
------------------------------
...
your ecurrencyd's P2P listen port (9333 by default).
	...
	-externalip=X   You can tell ecurrency about its publicly reachable address using
	                ...
	                /var/lib/tor/ecurrency-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./ecurrencyd -proxy=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -listen
...
for normal IPv4/IPv6 communication, use:
	...
	./ecurrency -onion=127.0.0.1:9050 -externalip=57qr3yd1nyntf5k.onion -discover
...
ECurrency Core automatically creates a hidden service to listen on. This will positively 
...
configured. For cookie authentication the user running ecurrencyd must have write access 
...
- Do not add anything but ecurrency ports to the hidden service created in section 2.
