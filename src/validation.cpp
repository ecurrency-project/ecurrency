...
#if defined(NDEBUG)
# error "ECurrency cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "ECurrency Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s ECR additional fees, %d delta bytes\n",
