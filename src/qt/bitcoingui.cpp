...
void BitcoinGUI::createActions()
{
    ...
    openAction->setStatusTip(tr("Open a ecurrency: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible eCurrency command-line options").arg(tr(PACKAGE_NAME)));
...
{
    QString strTitle = tr("eCurrency"); // default title
