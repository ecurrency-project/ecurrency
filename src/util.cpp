...
const char * const BITCOIN_CONF_FILENAME = "ecurrency.conf";
const char * const BITCOIN_PID_FILENAME = "ecurrency.pid";
...
#else
    const char* pszModule = "ecurrency";
#endif
    if (pex)
        return strprintf(
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/eCurrency";
#else
    // Unix
