...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ecurrency-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ecurrency-tx [options] <hex-tx> [commands]  Update hex-encoded ecurrency transaction\n" +
            "or:     ecurrency-tx [options] -create [commands]   Create hex-encoded ecurrency transaction\n" +
            "\n";
