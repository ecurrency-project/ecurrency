...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s ecurrency-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  ecurrency-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ecurrency transaction") + "\n" +
              "  ecurrency-tx [options] -create [commands]   " + _("Create hex-encoded ecurrency transaction") + "\n" +
              "\n";
